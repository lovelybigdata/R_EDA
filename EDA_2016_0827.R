...
star_03_order_main <- fread("R_EDA_by_KA_201609/01_star/01_big5/star_03_order_main.csv")
star_04_order_detail <- fread("R_EDA_by_KA_201609/01_star/01_big5/star_04_order_detail.csv")

# mac
star_03_order_main <- fread("R_EDA_by_KA_201609/01_star/02_utf8/star_03_order_main.csv")
star_04_order_detail <- fread("R_EDA_by_KA_201609/01_star/02_utf8/star_04_order_detail.csv")
...
#  補充資訊
# raw_data_mrt <- fread("R_EDA_by_KA_201609/02_MRT/01_big5/mrt_address_raw.csv"  )
  
# mac
# raw_data_mrt <- fread("R_EDA_by_KA_201609/02_MRT/02_utf8/mrt_address_raw.csv" , header = TRUE)
